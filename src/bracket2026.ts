...
export const R32_DRAW: DrawSlot[] = [
  { slot: 'r32_0',  matchNo: 74, teams: ['Germany', 'Paraguay'], result: { winner: 'Paraguay', score: '1-1 (4-3 pens)' } },
  { slot: 'r32_1',  matchNo: 77, teams: ['France', 'Sweden'], result: { winner: 'France', score: '3-0' } },
  { slot: 'r32_2',  matchNo: 73, teams: ['South Africa', 'Canada'], result: { winner: 'Canada', score: '0-1' } },
  { slot: 'r32_3',  matchNo: 75, teams: ['Netherlands', 'Morocco'], result: { winner: 'Morocco', score: '1-1 (3-2 pens)' } },
  ...
  { slot: 'r32_8',  matchNo: 76, teams: ['Brazil', 'Japan'], result: { winner: 'Brazil', score: '2-1' } },
  { slot: 'r32_9',  matchNo: 78, teams: ['Ivory Coast', 'Norway'], result: { winner: 'Norway', score: '1-2' } },
  { slot: 'r32_10', matchNo: 79, teams: ['Mexico', 'Ecuador'], result: { winner: 'Mexico', score: '2-0' } },
  { slot: 'r32_11', matchNo: 80, teams: ['England', 'DR Congo'], result: { winner: 'England', score: '2-1' } },
